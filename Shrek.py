...
class ZapomniMod(loader.Module):
	...
	async def sorrycmd(self, message):
		""".sorry <reply to user/text>"""
		...
		await message.edit("<b>Сам Бади вон</b>")
		pic = requests.get("https://www.meme-arsenal.com/memes/b1d08c66c082065dcf316104b22cd41b.jpg")
